...
export default function AboutMe() {
  ...
  return (
    <div id="about-me" className="section">
      ...
      <div id='about-me-div'>
              <h1 id='about-me-image'>IMAGE PLACEHOLDER</h1>
      ...
      {/* <img src='sunny.jpg' alt='sunny city' height='200px' width='100px' id='sunny'/>
      <img src='rainy.jpg' alt='rainy city' height='200px' width='100px' id='rainy'/> */}
    </div>
  )
}
